          ...
          <div class="navbar-nav" id="primero">
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a href="/verReservasCliente" class="dropdown-item">Reserva</a>
        ...
        <div class="table">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a class="btn btn-success" href="/verReservasCliente"><i class="material-icons">&#xE147;</i> <span>Agregar Reserva</span></a>
            ...
            <script type="text/javascript">
                ...
                function listarDastos(lista){
                    ...
                    $('#id_table').DataTable({
                        ...
                        columns:[
                            ...
                            {data: function(row, type, val, meta){
                                var salida='<button type="button" style="width: 50px" class="btn btn-danger btn-sm" onclick="elimin(\''+row.idReserva +'\')"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE5C9;</i></button>';
                                return salida;
                            },className:'text-center'},	
                        ]
                    });
                ...
                $("#id_btn_filtrar").click(function(){
                    ...
                    $.getJSON("listarReservasVer",{"filtro":fil},function(lista){
                        listarDastos(lista);
                    });
                });
                /*Filtrar Datos*/
                ...
                /*Eliminar*/
                /*Listar Foraneas*/
                $.getJSON("listaLocalidadVer", {}, function(data){
                ...
                /*Listar Foraneas*/
                /*Listar Foraneas*/
                $.getJSON("listaTipoReservaVer", {}, function(data){
                    $.each(data, function(i,item){
